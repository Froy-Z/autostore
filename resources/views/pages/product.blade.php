                    ...
                    <div class="my-4 px-4" data-accordion-details>
                        <table class="w-full">
                            <tr>
                                ...
                                <td class="py-2 text-black font-bold w-1/2">Черный, Натуральная кожа (WK)</td>
                            </tr>
                            <tr>
                                <td class="py-2 text-gray-600 w-1/2">Класс:</td>
                                <td class="py-2 text-black font-bold w-1/2">Бизнес-класс и представительский класс</td>
                            </tr>
                            <tr>
