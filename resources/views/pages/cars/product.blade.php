        ...
        <div class="col-span-1 lg:col-span-2">
            <div class="space-y-4 w-full">
                <div class="block px-4">
                    ...
                    @isset($car->old_price)
                        <p class="text-base line-through text-gray-400"><x-panels.format_price :price="$car->old_price"/></p>
                    @endisset
                    <p class="font-bold text-2xl text-orange"><x-panels.format_price :price="$car->price"/></p>
                ...
                <div class="block border-t clear-both w-full" data-accordion data-active>
                    ...
                    <div class="my-4 px-4" data-accordion-details>
                        <table class="w-full">
                            <x-panels.cars.car_specification :car="$car"/>
                            <tr>
